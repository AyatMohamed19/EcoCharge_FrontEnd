...
const handleUpdate=(e)=>
 {
    ...
    if(userData){
      axios.put(`https://ecocharge-backend-3ms8.onrender.com/api/user/put/${userData?._id}`,userData)
      .then((res)=>{
        ...
        <div className={`card ${isActive ? "black" : "" }`}>
            ...
            <form onSubmit={handleUpdate} style={{width:"200px",textAlign:"center"}}>
                <span >
                    ...
                    <label className="col-3" style={{alignSelf:" center",width:"30%"}}>Name</label>
                    ...
                    <div style={{display:"flex",justifyContent:"space-evenly",width: "100%",marginTop:"inherit"}}>
                            <input className="btnTagEdit" type="submit" value="save" />
