            ...
            <div className={`card ${isActive ? "black" : "" }`}>
                ...
                <div className="circle">
                    ...
                    <h6>{userData?.email}</h6>
                        ...
                        <button onClick={handleEdit}  className='btnTag btn btn-primary btn-lg sendBtn '>Edit</button>
                    <button onClick={props.logOut}  className='btnTag btn btn-primary btn-lg sendBtn '><Link to="/logout" style={{color:"white"}}>Log Out</Link></button>
                        </div>
