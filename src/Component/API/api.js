...
const requestWithOutToken = axios.create({
    baseURL:'https://ecocharge-backend-3ms8.onrender.com/api/',
...
const addStation  = async(station)=>{
   return await requestWithToken.post("https://ecocharge-backend-3ms8.onrender.com/api/stations/addstation",station,config())
}
